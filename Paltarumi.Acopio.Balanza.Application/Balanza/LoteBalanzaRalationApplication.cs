...
namespace Paltarumi.Acopio.Balanza.Application.Balanza
{
    public class LoteBalanzaRalationApplication : ApplicationBase, ILoteBalanzaRalationApplication
    {
        ...
        public async Task<ResponseDto<IEnumerable<ListLoteBalanzaRalationDto>>> List(int idLoteBalanza)
            => await _mediator.Send(new ListLoteBalanzaRalationQuery(idLoteBalanza));
        ...
        public async Task<ResponseDto<SearchResultDto<SelectLoteBalanzaRalationDto>>> Select(SearchParamsDto<SelectLoteBalanzaRalationFilterDto> searchParams)
            => await _mediator.Send(new SelectLoteBalanzaRalationQuery(searchParams));
    }
}
