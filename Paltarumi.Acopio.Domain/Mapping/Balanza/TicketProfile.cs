    ...
    public class TicketProfile : Profile
    {
        public TicketProfile()
        {
            ...
            CreateMap<Entity.Ticket, SearchTicketDto>()
                ...
                .ForMember(x => x.Transportista, opt => opt.MapFrom(x => x.IdTransporteNavigation != null ? x.IdTransporteNavigation.Numero + " - " +x.IdTransporteNavigation.RazonSocial : string.Empty))
