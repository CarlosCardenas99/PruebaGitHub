...
{
    public class SearchProveedorConcesionQueryHandler : SearchQueryHandlerBase<SearchProveedorConcesionQuery, ProveedorConcesionFilterDto, SearchProveedorConcesionDto>
    {
