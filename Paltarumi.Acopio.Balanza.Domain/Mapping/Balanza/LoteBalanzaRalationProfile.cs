    ...
    public class LoteBalanzaRalationProfile : Profile
    {
        public LoteBalanzaRalationProfile()
        {
            ...
            CreateMap<LoteBalanzaRalation, ListLoteBalanzaRalationDto>()
               ...
               .ForMember(x => x.CodigoTrujillo, opt => opt.MapFrom(x => x.IdLoteBalanzaOriginNavigation.CodigoTrujillo))
               .ForMember(x => x.CodigoAum, opt => opt.MapFrom(x => x.IdLoteBalanzaOriginNavigation.CodigoAum))
               ...
               .ForMember(x => x.CantidadSacos, opt => opt.MapFrom(x => x.IdLoteBalanzaOriginNavigation.CantidadSacos))
